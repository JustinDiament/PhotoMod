...
public class PixelImpl implements Pixel {
  ...
  public PixelImpl(int red, int green, int blue) {
    // INVARIANT: this.red, this.green, and this.blue must be greater than or equal to 0
    // INVARIANT: this.red, this.green, and this.blue must be less than or equal to 255
