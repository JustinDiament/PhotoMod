...
public class ImageLayerModelImpl extends ImageProcessingModelImpl {
  ...
  // todo: add this to new interface
  public void setCurrentLayerVisiblity() {
    this.getCurrentLayer().setVisibility();
  }
  ...
  public Image applyOperation(Image img, Operations o) throws IllegalArgumentException {
    ...
    layers.set(this.currentLayer, new LayerImpl(newImage));
    return newImage;
  }
